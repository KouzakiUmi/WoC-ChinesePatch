...
| 当前版本 | v1.3.9：三轮校对修复 873 行译文 + 图片重制并独立验收 |
...
- **术语族全部归零**：萨鲁斯、先知、城镇广场、公事房、相位、灵力族、空甲、情谊/牵绊、隧道→地道、personal quarters→个人住所、crew quarters 按场景分工（陆上**成员宿舍** / 船上**船员舱**）
...
- 首轮：17 书页、6 地图、4 教程从英文原图重制；次轮：青绿键控残色清零、教程透明度恢复、教程截图回中文、书页语义重译；第三轮：`RebelHQMap` 标签「个人房间→个人住所」、`b0009` 连接词「因此→反而」
...
从 v1.3.8 及更早版本升级到 v1.3.9 时，请先用旧版补丁卸载，再安装新版，以清理旧版文件。
