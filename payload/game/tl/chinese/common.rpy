# TODO: Translation updated at 2026-09-22 01:27
...
translate chinese strings:
    ...
    new "本程序包含多种许可协议下的自由软件，包括 MIT 许可证和 GNU 宽通用公共许可证。完整的软件列表（含完整源代码链接）可在{a=https://www.renpy.org/l/license}此处{/a}找到。"
    ...
    new "\n{color=#cfc}✔ 已预测图像（良好）{/color}\n{color=#fcc}✘ 未预测图像（不佳）{/color}\n{color=#fff}拖动以移动。{/color}"
    ...
    new "此电脑在显示图形时出现问题：[problem]。"

    # 00gltest.rpy:229
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display. Updating DirectX could fix this problem."
    new "其显卡驱动可能已过时或无法正常运行。这可能导致图形显示缓慢或不正确。更新 DirectX 或许能解决此问题。"

    # 00gltest.rpy:231
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "其显卡驱动可能已过时或无法正常运行。这可能导致图形显示缓慢或不正确。"
    ...
    new "DirectX 网页安装程序已启动。它可能会在任务栏中最小化启动。请按提示安装 DirectX。"

    # 00gltest.rpy:272
    old "{b}Note:{/b} Microsoft's DirectX web setup program will, by default, install the Bing toolbar. If you do not want this toolbar, uncheck the appropriate box."
    new "{b}注意：{/b}微软的 DirectX 网页安装程序默认会安装必应工具栏。如果您不想要此工具栏，请取消勾选相应的复选框。"

    # 00gltest.rpy:276
    old "When setup finishes, please click below to restart this program."
    new "安装完成后，请点击下方按钮重启本程序。"
