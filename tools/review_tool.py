...
# 只保留真正"念台词"的文言词; 何况/并非/加以/从而 等在受教育角色口中属正常表达
WRITTEN_MARKS = ["亦然", "意欲何为", "乃至", "皆", "乃", "尚且", "故而",
                 "由此可见", "极为", "甚为", "颇为", "亦", "遂", "何须"]
# 奇幻语境里的现代职场/技术词 (独白或对话出现都不自然)
# 注意: 图书管理员(Librarian)是正确的, 不列入
MODERN_MARKS = ["团队", "优先级", "进度", "效率", "资源", "失业", "流程", "反馈", "沟通"]
